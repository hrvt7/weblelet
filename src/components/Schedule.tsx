      ...
      <div className="mx-auto max-w-3xl px-5 sm:px-6 lg:px-8">
        ...
        <FadeIn delay={0.24}>
          <div className="mt-8 space-y-4 text-center">
            <a
              href="tel:+3694900887"
              className="inline-flex items-center gap-2.5 rounded-2xl bg-primary px-8 py-4 text-[1rem] font-bold text-white shadow-lg shadow-primary/20 cta-glow cursor-pointer"
            >
