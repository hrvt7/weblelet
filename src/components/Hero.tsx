    ...
    <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 lg:pt-44 lg:pb-32 overflow-hidden wave-divider">
      ...
      <div className="absolute inset-0 -z-20">
        ...
        <img
          ...
          alt="Fogászati implantátum illusztráció — Dr. Minta Réka fogorvosi rendelő, Budapest"
          ...
          <div className="lg:col-span-7">
            ...
            <FadeIn delay={0.12}>
              <p className="mt-7 text-lg leading-relaxed text-foreground-secondary max-w-[540px]">
                Modern eszközök, gondos odafigyelés, TB-támogatott ellátás. Budapest, Példa utca 10.
              </p>
            </FadeIn>
                ...
                >
                  ...
                  <div className="p-4 text-center">
                    <div className="flex items-center justify-center gap-2">
                      <h3 className="font-heading font-bold text-foreground text-base">Dr. Minta Réka</h3>
                    ...
                    <p className="text-xs text-foreground-muted mt-0.5">Fogorvos — Budapest</p>
                  </div>
