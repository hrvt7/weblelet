...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Mélyebb E-E-A-T és tartalom minőség audit",
      "Top 3 versenytárs GEO score összehasonlítás",
      "Multi-platform AI readiness (ChatGPT, Gemini, Bing, Perplexity)",
      "Teljes implementációs prioritáslista — fejlesztőnek átadható",
    ],
