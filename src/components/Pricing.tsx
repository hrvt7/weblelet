...
const plans = [
  {
    ...
    features: ["GEO/SEO + Marketing pontszám", "TOP 5 probléma címkézve (tény/feltételezés)", "3 azonnali teendő + kész megoldások (schema, llms.txt)"],
    cta: "Kérem ingyen →",
    featured: false,
  },
  {
    ...
    features: [
      ...
      "Cselekvési terv üzleti hatás értékeléssel",
      "Szolgáltatási csomag ajánlat (3 opció)",
      "30 napos tartalom naptár + email szekvenciák",
