...
export default function ServicePage({ title, subtitle, image, sections, relatedServices }: ServicePageProps) {
  return (
    <>
      {/* Hero */}
      <section className="pt-32 pb-16 sm:pt-40 sm:pb-20 bg-surface-alt relative">
        <div className="absolute inset-0 dot-grid opacity-[0.1] -z-10" />
        <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8">
          <FadeIn>
            <a href="/#szolgaltatasok" className="inline-flex items-center gap-1.5 text-sm text-primary font-medium hover:text-primary-dark transition-colors mb-6">
        ...
        <div className="mx-auto max-w-4xl px-5 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-14">
            ...
            <div className="lg:col-span-3 space-y-10">
              ...
              {/* CTA */}
              <FadeIn delay={0.3}>
                <div className="rounded-2xl bg-primary/5 border border-primary/10 p-6 sm:p-8">
